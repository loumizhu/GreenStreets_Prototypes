...
(function () {
  ...
  /* The retailer's category list — js/ra-categories.js holds the one copy. This page used
     to carry its own hardcoded copy ('Apparel', 'Homeware', 'Electronics'…) which matched
